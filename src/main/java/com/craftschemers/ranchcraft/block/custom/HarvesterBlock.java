package com.craftschemers.ranchcraft.block.custom;
...
public class HarvesterBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.HARVESTER_BLOCK_ENTITY, HarvesterBlockEntity::tick);
    }
